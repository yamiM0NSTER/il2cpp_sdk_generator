...
namespace il2cpp_sdk_generator
{
  public class ResolvedField : ResolvedObject
  {
    ...
    ResolvedType _resolvedType = null;
    ...
    public bool isPublic
    {
      get
      {
        return (type.attrs & il2cpp_Constants.FIELD_ATTRIBUTE_FIELD_ACCESS_MASK) == il2cpp_Constants.FIELD_ATTRIBUTE_PUBLIC;
      }
    }
    ...
    ResolvedType ResolvedType
    {
      get
      {
        ...
        {
          _resolvedType = MetadataReader.GetResolvedType(type);
        }
    ...
    public bool isEnum
    {
      get => ResolvedType != null && ResolvedType.isEnum;
    }
    ...
    public uint Offset
    {
      get => il2cppReader.GetFieldOffset(declaringTypeDefIndex, fieldIndex);
    }
    ...
    public string ToCode(Int32 indent)
    {
      ...
      code += $"{TypeString} {Name.CSharpToCppIdentifier()}; // 0x{this.Offset:X}\n".Indent(indent);
